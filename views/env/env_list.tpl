		...
		<div class="col-md-4">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-yellow">
              <h3 class="widget-user-username">测试环境</h3>
              ...
              <div class="row">
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    ...
                    <span class="description-text">节点数量</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header">13,0</h5>
                    <span class="description-text">项目数量</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
                <div class="col-sm-4">
                  <div class="description-block">
                    ...
                    <span class="description-text">主机数量</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
        ...
        <div class="col-md-4">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-aqua-active">
              <h3 class="widget-user-username">开发环境</h3>
              <h5 class="widget-user-desc">Founder &amp; CEO</h5>
            </div>
            <div class="widget-user-image">
              <img class="img-circle" src="/static/img/user1-128x128.jpg" alt="User Avatar">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-black" style="background: url('static/img/photo1.png') center center;">
              <h3 class="widget-user-username">运维环境</h3>
