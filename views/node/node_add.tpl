                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">XX项目XX环境</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" data-placeholder="选择主机"
                                                style="width: 100%;">
                                            <option>192.168.2.1</option>
                                            <option>192.168.2.2</option>
                                            <option>192.168.2.3</option>
                                            <option>192.168.2.4</option>
                                            <option>192.168.2.5</option>
                                        </select>
