...
func InitSql() {
	...
	orm.RegisterModelWithPrefix(prefix, new(mir.Mirrorgroup), new(mir.Mirror), new(mur.User), new(mur.Position), new(men.Env), new(mcn.Config), new(mcn.Configver), new(mac.Machine))
